...
def plotCont(img, mask_name, svel, cmap, window, fitsdata): 
    ...
    def plotchans(fts,colormap,colorlab,coltick,bw,pad,barsh,\
        ...
        mask_arr,maskfreq,maskra,maskde,maskdra,maskbmaj,maskbmin,maskbpa,maskvel \
            = readingrainbowCASA(mask_img,rapo,depo,nchannels,svel,flip,fitsdata = False)
        ...
        fig = plt.figure(1,figsize=(7,40)) #change until looks square
        fig.clf()
        ncol =1
        ...
        for nc in range(nchannels):
            ...
            if nc == add_details and fitsdata == True:
                ...
                ellpo = window - 3.0 # position of the ellipse -- center of where the beam goes
    ...
    nchannels = 1 # number of channels to plot around center of line, +/- nchannels/2
